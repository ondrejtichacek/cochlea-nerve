function [xnew, y, yerr] = fig3b(xnew, args)
arguments
...
f_mean = fullfile(folder, 'f3b_raw_mean.csv');
f_top_err = fullfile(folder, 'f3b_raw_top_err.csv');
f_bot_err = fullfile(folder, 'f3b_raw_bot_err.csv');
...
xeb = xeb + 0.01; % to fix uniqueness
